...
_cfg = {
    ...
    'swin_base_patch4_window7_224': dict(
        ...
        params=dict(pretrain_img_size=224, patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18),
                    num_heads=(4, 8, 16, 32))
    ),
    ...
    'swin_base_patch4_window12_384_in22k': dict(
        ...
        params=dict(pretrain_img_size=384, patch_size=4, window_size=12, embed_dim=128, depths=(2, 2, 18),
                    num_heads=(4, 8, 16, 32))
    ),
