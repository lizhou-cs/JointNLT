...
class EnvSettings:
    def __init__(self):
        ...
        self.got_reports_path = '{}/test/analysis/'.format(test_path)
        self.otb_path = ''
        self.nfs_path = ''
        self.uav_path = ''
        self.tpl_path = ''
...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.otb_path = os.path.join(data_dir, 'OTB_sentences')
        ...
        self.lasot_path = os.path.join(data_dir, 'LaSOTTest')
        ...
        self.lasottext_path = os.path.join(data_dir, 'LaSOTText')
        self.davis_dir = ''
        self.youtubevos_dir = ''

        self.got_packed_results_path = ''
        self.got_reports_path = '{}/test/analysis/'.format(workspace_dir)
...
def create_default_local_file_ITP_test(workspace_dir, data_dir, save_dir):
    ...
    path = os.path.join(os.path.dirname(__file__), 'local.py')
    print('create_default_local_file_ITP_test Path:{}'.format(path))
    with open(path, 'w') as f:
