...
def main():
    ...
    parser.add_argument('--params__vis_attn', type=int, choices=[0, 1], default=0, help="Whether visualize the "
                                                                                        "attention maps.")
    parser.add_argument('--params__first_frame', type=int, choices=[0, 1], default=0, help="Whether use the "
                                                                                        "first frame.")
    ...
    print(f'tracker_params:{tracker_params}')
