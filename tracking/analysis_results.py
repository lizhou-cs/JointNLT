...
from lib.test.analysis.plot_results import plot_results, print_results, print_per_sequence_results, plot_got_success
...
trackers.extend(trackerlist(name='jointnlt', parameter_name=args.tracker_param, dataset_name=args.dataset_name,
...
# plot_got_success(trackers, 'result_plots')
